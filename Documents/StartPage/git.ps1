###ha nem müködne akkor elsőnek futtatni ::: Set-ExecutionPolicy RemoteSigned
...
$Form.controls.AddRange(@($Panel_default)) ###vesszővel választjuk el ha több panel van
...
$Panel_default.controls.AddRange(@($gitHub_init,$git_clone,$gitHub_commit)) ###vesszővel választjuk el ha több elem van
